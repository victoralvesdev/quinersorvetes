    ...
    <div className="p-3 sm:p-4 lg:p-8 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
          {/* Date Range Selector */}
          <div className="flex bg-white rounded-lg sm:rounded-xl border border-gray-100 p-0.5 sm:p-1 shadow-sm">
            {[
              ...
              <button
                ...
                className={cn(
                  "px-2 sm:px-4 py-1.5 sm:py-2 rounded-md sm:rounded-lg text-xs sm:text-sm font-medium transition-all duration-200",
          ...
          <button
            ...
            className="p-2 sm:p-3 bg-white hover:bg-gray-50 rounded-lg sm:rounded-xl border border-gray-100 shadow-sm transition-all duration-200 disabled:opacity-50"
          >
            <RefreshCw className={cn("w-4 h-4 sm:w-5 sm:h-5 text-secondary", isRefreshing && "animate-spin")} />
          </button>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <>
                ...
                >
                  ...
                  <div className="relative flex items-start justify-between">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className={cn("text-xl sm:text-2xl font-bold mb-1", stat.valueColor)}>
                        {stat.value}
                      </p>
                      {stat.change !== null && (
                        <div className={cn(
                          ...
                          <span className="truncate">{Math.abs(stat.change).toFixed(1)}% vs periodo anterior</span>
                        </div>
                      )}
                    </div>
                    <div className={cn("p-2 sm:p-3 rounded-xl shadow-sm flex-shrink-0", stat.iconBg)}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            {/* Revenue Chart */}
            <div className="lg:col-span-2 bg-white rounded-xl sm:rounded-2xl border border-gray-100 shadow-sm p-3 sm:p-4 lg:p-6 overflow-hidden">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div>
                  <h3 className="font-bold text-base sm:text-lg text-secondary-dark">Faturamento Semanal</h3>
                  <p className="text-xs sm:text-sm text-secondary/50">Ultimos 7 dias</p>
                </div>
              ...
              <div className="w-full overflow-x-auto pb-2 -mx-1 px-1 scrollbar-hide">
                <div className="flex items-end justify-between gap-1 sm:gap-2 h-40 sm:h-48 min-w-[500px] sm:min-w-0">
                  {dailyStats.map((day, index) => (
                    <div key={index} className="flex-1 flex flex-col items-center gap-1.5 sm:gap-2 min-w-0">
                      <div className="w-full flex flex-col items-center">
                        <span className="text-xs font-semibold text-secondary-dark mb-1 whitespace-nowrap">
                      ...
                      <div className="text-center w-full">
                        <p className="text-xs font-semibold text-secondary-dark truncate">{day.dayName}</p>
                        <p className="text-xs text-secondary/50 truncate">{day.date}</p>
                      </div>
                    </div>
                  ))}
                </div>
